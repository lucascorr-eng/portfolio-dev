    ...
    <>
      <div className="font-inter text-sm px-6">
        ...
        <p className="text-gray-500 mb-5">
          Construo interfaces que as pessoas adoram usar e sistemas que escalam
          com elegância. Código limpo, UX bem pensada.
        </p>

        <div className="bg-gray-900 text-xs p-3 mb-5 rounded-lg font-firaCode text-mist-700 grid gap-1.5">
          <p>
            1{" "}
